...
import 'package:epicor/src/view/TFShipment/screen_transfer_shipment_entry_pcid.dart';
...
class ScreenTransferShipmentMainPcid extends StatefulWidget {
  const ScreenTransferShipmentMainPcid({super.key});

  @override
  State<ScreenTransferShipmentMainPcid> createState() =>
      _ScreenTransferShipmentMainPcidState();
}

class _ScreenTransferShipmentMainPcidState
    extends State<ScreenTransferShipmentMainPcid> {
  bool isLoading = true;
  ...
  gotoEntryPage(item) async {
    ...
    await Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => ScreenTransferShipmentEntryPcid(
          item: itemP,
        ),
      ),
    );
