...
import 'package:epicor/src/view/shipment/screen_shipment_details.dart';
...
class ScreenShipmentMain extends StatefulWidget {
  ...
  State<ScreenShipmentMain> createState() => _ScreenShipmentMainState();
}

class _ScreenShipmentMainState extends State<ScreenShipmentMain> {
  ...
  gotoDetailsPage(dynamic record, bool isN) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => ScreenShipmentDetails(
          item: record,
          isNew: isN,
        ),
      ),
